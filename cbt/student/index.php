    ...
    <div class="row p-0">
        <div class="col-lg-2 py-3 text-secondary side-nav">
            <ul class="sidebar">
                ...
                <li id="add_exam"><i class="bi bi-table me-5"></i> Results</li>
                <li id="students"><i class="bi bi-database-fill me-5"></i>Exam History</li>
                                        ...
                                        <div class="row p-2 rounded-3">
                                            ...
                                            <div class="col-lg-7 mx-auto">
                                                ...
                                                <table class="table table-striped">
                                                    ...
                                                    <tr><td>Class</td><td><?= $_SESSION["user"]["class"]; ?></td></tr>
                                                    <tr><td>Session</td><td><?= $_SESSION["user"]["user_role"]; ?></td></tr>
